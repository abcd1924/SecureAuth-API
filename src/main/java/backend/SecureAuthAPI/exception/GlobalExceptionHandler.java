...
public class GlobalExceptionHandler {
     ...
     * This catches BadCredentialsException thrown by AuthenticationManager when
     * credentials are
     ...
     * Returns 400 BAD_REQUEST since this is a validation error, not an
    ...
    /**
     * Handles validation errors from @Valid @RequestBody annotations on request
     * DTOs.
